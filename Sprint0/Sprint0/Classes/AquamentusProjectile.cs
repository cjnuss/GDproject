...
namespace Sprint0
{
    public class AquamentusProjectile : ISprite1
    {
        ...
        {
            location1 = new Vector2(location.X + 8, location.Y + 11);
            location2 = new Vector2(location.X + 8, location.Y + 11);
            location3 = new Vector2(location.X + 8, location.Y + 11);
        }
        ...
        public void Draw(SpriteBatch spriteBatch)
        {
            if (currentFrame != totalFrames)
            {
                ...
                Rectangle destinaton1 = new Rectangle((int)location1.X, (int)location1.Y, source.Width, source.Height);
                Rectangle destinaton2 = new Rectangle((int)location2.X, (int)location2.Y, source.Width, source.Height);
                Rectangle destinaton3 = new Rectangle((int)location3.X, (int)location3.Y, source.Width, source.Height);
